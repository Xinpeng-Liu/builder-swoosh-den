  ...
  const mockCharacters: Character[] = [
    {
      ...
      role: "Protagonist",
      imageUrl:
        "https://api.builder.io/api/v1/image/assets/TEMP/5821b6aa396b0511f311c392689060b59165fad7?width=423",
      appearance:
        "Cybernetic officer with determined expression. Short hair with cybernetic enhancements.",
    ...
    },
    {
      ...
      role: "Antagonist",
      imageUrl:
        "https://api.builder.io/api/v1/image/assets/TEMP/327c573275f90714e5fc082eb19efa30fb5af628?width=423",
      appearance:
        "Elderly businessman with calculating expression and formal suit.",
    ...
    },
    {
      ...
      role: "Mentor",
      imageUrl:
        "https://api.builder.io/api/v1/image/assets/TEMP/a4e4a4142936de335afe5db4326fa663156cf842?width=423",
      appearance:
        "Elderly scientist with wise eyes and grey beard. Often seen in research attire.",
    ...
    },
    {
      ...
      role: "Ally",
      imageUrl:
        "https://api.builder.io/api/v1/image/assets/TEMP/bfab3bf8103c4269e3dc36705e7b3b4d55de5f86?width=423",
      appearance:
        "Data tech specialist with confident demeanor and modern styling.",
    ...
    },
    {
      ...
      role: "Supporting",
      imageUrl:
        "https://api.builder.io/api/v1/image/assets/TEMP/9c9f023457482aacb444e53278bc0ce55e5370a5?width=423",
      appearance:
        "A mysterious figure always wearing a dark hoodie that obscures most of their face. Slim build, moves with purpose and agility. Often seen in the shadows of neon-lit streets. Has a cybernetic implant visible on one hand.",
