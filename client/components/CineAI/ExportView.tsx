...
export function ExportView() {
  ...
  const [outputLocation, setOutputLocation] = useState(
    "/Users/username/Documents/Films",
  );
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="p-6 bg-[hsl(var(--cine-sidebar))] border border-[hsl(var(--cine-border))] rounded-xl">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button
                size="sm"
                className="bg-[hsl(var(--cine-card))] hover:bg-[hsl(var(--cine-card))]/80"
              >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <Button
                      size="sm"
                      className="bg-[hsl(var(--cine-card))] rounded-l-none border-l-0"
                    >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Your film will be exported with the selected settings
                </p>
              </div>
      ...
      <div className="w-64 bg-[hsl(var(--cine-sidebar))] border-l border-[hsl(var(--cine-border))] p-4">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            <Button
              variant="ghost"
              className="w-full justify-between bg-[hsl(var(--cine-card))] hover:bg-[hsl(var(--cine-card))]/80"
            >
              <div className="flex items-center gap-3">
            ...
            <Button
              variant="ghost"
              className="w-full justify-start bg-[hsl(var(--cine-card))] hover:bg-[hsl(var(--cine-card))]/80"
            >
        ...
        <div>
          ...
          <div className="space-y-3">
            {exportHistory.map((item, index) => (
              <div
                key={index}
                className="p-3 bg-[hsl(var(--cine-card))] rounded-md"
              >
