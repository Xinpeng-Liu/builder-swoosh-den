    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-5">
        ...
        <div className="flex gap-4 mb-6">
          <div 
            className="w-42 h-36 p-4 flex flex-col items-center justify-center border-2 border-dashed border-[hsl(var(--cine-border))] bg-[hsl(var(--cine-sidebar))] rounded-lg cursor-pointer hover:border-purple-500 transition-colors"
